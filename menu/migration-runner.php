<?php
	$site_url = isset($_POST['uxi-url']) ? $_POST['uxi-url'] : get_option('uxi_migrator_site_url');
?>
...
<div class="migration-runner-wrap">
	...
	<div class="migrator-form">
	   ...
	   <form method="post" action="<?php menu_page_url('uxi-migration',true); ?>">
	     <p>
	        ...
	        <input type="text" id="uxi-url" name="uxi-url" class="regular-text" required placeholder="https://uxi-website.com" value="<?php echo $site_url; ?>">
	     </p>
	     <p>
	...
	<?php if (isset($_POST['uxi-url'])): ?>
		...
		<?php
			...
			ob_start(); ?>
				<script>
					const uxiUrl = "<?php echo trailingslashit($_POST['uxi-url']); ?>";
					const migrationUrl = "<?php echo get_rest_url(null, 'uxi-migrator/run'); ?>";
					const progressUrl = "<?php echo get_rest_url(null, 'uxi-migrator/get-status'); ?>";
